...
$('#home').click(function(){
    ...
    $('#admin_agent').css('display','none');
    $('#supper_agent').css('display','none');
    $('#master_agent').css('display','none');
});
...
$('#super_admin').click(function(){
    ...
    $('#home_section').css('display','none');
    $('#admin_agent').css('display','none');
    $('#supper_agent').css('display','block');
    $('#master_agent').css('display','none');
});
$('#master_admin').click(function(){
    ...
    $('#admin_agent').css('display','none');
    $('#supper_agent').css('display','none');
    $('#master_agent').css('display','block');
});
